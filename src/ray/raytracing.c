...
/*   Updated: 2024/10/15 23:53:52 by yroussea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
float	phong(t_ray ray, t_light *light, t_ray tmp, t_vec3d normal)
{
	...
	return (COEF_DIFFUSE * light->intensity * ft_fmax(0, ft_vec3d_dot(normal, l)) +
		COEF_SPECULAR * light->intensity * powf(ft_fmax(0, ft_vec3d_dot(normal, h)), COEF_EXPOS_SPECULAR));
}
