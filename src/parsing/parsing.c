...
/*   Updated: 2024/10/13 21:55:14 by yroussea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	parsing(char *file_scene)
{
	...
	add_objects(plane((t_vec3d){0, 1, 0}, (t_vec3d){0, -25, 0}, (t_vec3d){0, 1, 0}));

	add_objects(light((t_vec3d){0}, 0, AMBIANCE_LIGHT,(t_vec3d){1, 1, 1}));
